...
- Ant Design library 사용으로 자동 캐러셀

## [최신순 & 좋아요순으로 정렬]

- 라이브러리 사용으로 sort 함수, new Date를 사용해 mock data를 최신순, 좋아요 많은 순으로 정렬
...
- 박보현: merge하고 각자 작업하며 백엔드와 통신하면서 메인 페이지에 보여지는 thumbnail 사진과 상세페이지 세부 사항 image의 key 값이 일치되지 않아 포기해야 됐던 항목이 있어서 아쉬웠습니다. 앞으로는 merge를 하고 작업하는 시간을 충분히 확보하고 싶습니다. 1차 프로젝트 때 구현하지 않았던 새로운 기능을 구현해 볼 수 있는 기회가 있어 의미 있었고 라이브러리를 처음 사용하며 다양한 기능을 구현할 수 있는 장점도 경험했습니다. 앞으로 웹 사이트에서 새롭고 다양한 기능을 구현하기 위해 개인 및 그룹 프로젝트를 진행하고 다양한 관점으로 생각하는 개발자가 되고 싶습니다.
